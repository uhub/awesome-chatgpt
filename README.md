...
* [yokingma/search_with_ai](https://github.com/yokingma/search_with_ai) - 🤖  AI Search, 💡 Support DeepResearch, 🧠  DeepSeek R1, 📍 Ollama/LMStudio, SearXNG, Docker.  AI搜索引擎，支持DeepResearch, 本地模型、深度思考模型（DeepSeek R1）、聚合搜索引擎SearXNG，支持Docker一键部署。
