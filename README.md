...
* [showlab/Image2Paragraph](https://github.com/showlab/Image2Paragraph) - Transform Image into Unique Paragraph with ChatGPT, BLIP2, OFA, GRIT, Segment Anything, ControlNet.
...
* [alibaba/Chat2DB](https://github.com/alibaba/Chat2DB) - 一个集成了AIGC的数据库客户端工具
...
* [zjunlp/Prompt4ReasoningPapers](https://github.com/zjunlp/Prompt4ReasoningPapers) - Repository for the paper "Reasoning with Language Model Prompting: A Survey".
...
* [cocacola-lab/ChatIE](https://github.com/cocacola-lab/ChatIE) - official repository for ChatIE paper and a tool of  IE using ChatGPT. Note: we set a default openai key in the tool, you can tell us if reach limit.  The response speed depends on the official openai chatgpt api. ( sometimes, the official is too crowded and the speed/model will be slow/overloaded.)
...
* [MQEnergy/chatcat](https://github.com/MQEnergy/chatcat) - ChatCat ChatGPT Client
...
* [TuringAI-Team/chatgpt-discord-bot](https://github.com/TuringAI-Team/chatgpt-discord-bot) - A discord bot for interact with ChatGPT
...
* [haozi/New-Bing-Anywhere](https://github.com/haozi/New-Bing-Anywhere) - New-Bing-Anywhere extension's source ⚠️The latest Chrome isn't compatible. Wait for Google-webstore's approval or manually install releases>=v1.7.0. See https://github.com/haozi/New-Bing-Anywhere/issues/19#issuecomment-1513620970
...
* [qnscholar/zotero-chatgpt](https://github.com/qnscholar/zotero-chatgpt) - 引入 ChatGPT 后的 Zotero，会带来哪些生产力提升呢？
...
* [yeokm1/doschgpt](https://github.com/yeokm1/doschgpt) - A proof-of-concept ChatGPT client for DOS.
...
* [shm007g/LLaMA-Cult-and-More](https://github.com/shm007g/LLaMA-Cult-and-More) - Keeping Track of Affordable Language Models, 🦙 Cult and More
...
* [a616567126/GPT-WEB-JAVA](https://github.com/a616567126/GPT-WEB-JAVA) - 基于JDK8的ChatGPT对话后台
...
* [tan92hl/Complex-Question-Answering-Evaluation-of-ChatGPT](https://github.com/tan92hl/Complex-Question-Answering-Evaluation-of-ChatGPT) - A large-scale complex question answering evaluation of ChatGPT and similar large-language models
...
* [kharvd/gpt-cli](https://github.com/kharvd/gpt-cli) - Command-line interface for ChatGPT
...
* [shfshanyue/wechat-chatgpt](https://github.com/shfshanyue/wechat-chatgpt) - 一个基于 ChatGPT 的 AI 助手微信机器人，支持个人微信与企业微信
...
* [AllenInstitute/openai_tools](https://github.com/AllenInstitute/openai_tools) - Growing set of scripts to explore pdf publication using ChatGPT API
...
* [yagil/ChatIDE](https://github.com/yagil/ChatIDE) - AI Coding Assistant in your IDE - OpenAI's ChatGPT and Anthropic's Claude in VS Code.
...
* [yangjiakai/lux-admin-vuetify3](https://github.com/yangjiakai/lux-admin-vuetify3) - Create the best admin based on Vuemo3, Vite3, TypeScript, Vuetify3, Firebase etc.
...
* [a616567126/GPT-WEB-CLIENT](https://github.com/a616567126/GPT-WEB-CLIENT) - 基于VUE2.0的ChatGPT对话客户端
