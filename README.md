...
* [danny-avila/chatgpt-clone](https://github.com/danny-avila/chatgpt-clone) - Clone of ChatGPT, uses official model & Bing, reverse-engineered UI, with AI model switching, message search, ChatGPT Plugins, Multi-User System, & Prompt Templates (WIP)
...
* [whyiyhw/chatgpt-wechat](https://github.com/whyiyhw/chatgpt-wechat) - 可在 微信/企业微信 安全使用的 ChatGPT 个人助手应用
...
* [Soulter/QQChannelChatGPT](https://github.com/Soulter/QQChannelChatGPT) - ⭐高可用 😊多平台 ✨低耦合的ChatGPT/Bing聊天机器人 | 在QQ和QQ频道上聊天 | ChatGPT API on QQ
...
* [ObservedObserver/viz-gpt](https://github.com/ObservedObserver/viz-gpt) - Create and edit data visualization with simple chat.
...
* [rsaryev/auto-copilot-cli](https://github.com/rsaryev/auto-copilot-cli) - Auto Copilot CLI - a tool for developers that allows you to automatically refactor code, generate commands, chat with a chatbot and analyze errors using the OpenAI API.
...
* [adamlui/userscripts](https://github.com/adamlui/userscripts) - 🐵 MTurk, ChatGPT and other Greasemonkey userscripts // MTurk, ChatGPT 和其他 Greasemonkey 用户脚本
...
* [railsjazz/ask_chatgpt](https://github.com/railsjazz/ask_chatgpt) - AI-Powered Assistant Gem right in your Rails console.
...
* [kharvd/gpt-cli](https://github.com/kharvd/gpt-cli) - Command-line interface for ChatGPT and Claude
...
* [c-ttpfx/chatgpt-java-wx](https://github.com/c-ttpfx/chatgpt-java-wx) - 使用chatgpt提供的接口，实现自己的微信聊天小程序。java编写服务器，实现chatgpt接口的调用。微信小程序用于聊天。二者基于webSocket进行通信
...
* [eeeXun/gtt](https://github.com/eeeXun/gtt) - Google Translate TUI (Originally). Now support Apertium, Argos, Bing, ChatGPT, Google, Reverso.
...
* [lyr1cx/ChatGPT-Alfred](https://github.com/lyr1cx/ChatGPT-Alfred) - Integrate ChatGPT with AlfredApp
...
* [Doujiang2333/ChatGPT-Galgame](https://github.com/Doujiang2333/ChatGPT-Galgame) - 用于chatgpt的猫娘调教及角色扮演
