...
* [yokingma/search_with_ai](https://github.com/yokingma/search_with_ai) - 🤖  AI Search, 💡 Support DeepResearch, 🧠  DeepSeek R1, 📍 Support Ollama/LMStudio, SearXNG, Docker deployment.  AI搜索引擎，支持DeepResearch, 支持本地模型、支持深度思考模型（DeepSeek R1）、聚合搜索引擎SearXNG，支持Docker一键部署。
