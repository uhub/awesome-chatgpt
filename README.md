...
* [zhaoweih/Shadowsocks-Tutorial](https://github.com/zhaoweih/Shadowsocks-Tutorial) - 🐱给小白的Shadowsocks和V2ray翻墙教程-Easy-to-follow tutorials for beginners on using Shadowsocks and V2ray to bypass internet restrictions.-給小白的Shadowsocks和V2ray翻牆教程
...
* [LlmKira/Openaibot](https://github.com/LlmKira/Openaibot) - ⚡️ Build Your Own AssistantBot|🧀 Discord/Slack/Kook/Telegram |🍓 链式唤醒复刻 ChatGpt 架构 |⛓ Self-driven Chain Runner | 🪄 Send Message everywhere |🔖  Plugin Support | 🌻 sh & docker-compose | Good Practices of function-calling
...
* [SciSharp/BotSharp](https://github.com/SciSharp/BotSharp) - The LLM Application Framework in .NET
...
* [steedos/steedos-platform](https://github.com/steedos/steedos-platform) - Steedos is an open-source alternative to Salesforce's low-code platform, 🤖 🎨 🚀    offering Steedos DX as a novel approach to managing and developing low-code apps throughout their entire lifecycle, enabling source-driven development.
...
* [SciSharp/LLamaSharp](https://github.com/SciSharp/LLamaSharp) - Make local LLaMA/GPT model inference easy in C#!🤗 It's fast with both cpu and gpu, providing many high-level APIs and with semantic-kernel and kernel-memory integration. It's also easy to use LLamaSharp with unity, WPF and WebApp.
...
* [lich0821/WeChatFerry](https://github.com/lich0821/WeChatFerry) - 微信逆向，微信机器人，可接入 ChatGPT、讯飞星火、Tigerbot等大模型。Hook WeChat.
...
* [vastsa/AILink](https://github.com/vastsa/AILink) - ChatGPT 商业版最强，自定义插件，自定义模型，自定义接口，ChatGPT4，Midjourney绘图，Claude，百度文心一言，Azure，轻应用模块，用户登录注册，邀请激励，在线支付，角色扮演，实时连续对话网页版，查询余额，完全自定义模型接口，可自己对接，代码显示高亮
